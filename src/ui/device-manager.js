...
function _defaultDevice(name) {
  return {
    ...
    relays: [
      ...
      { name: 'Relay 2', en: false, s1: { en: false, ip: 1000,  tms: 0.8,  ct: 'VI', mop: 30 }, s2: { en: false, ip: 10,  tms: 0.85, ct: 'EI', mop: 30 }, dt: { en: true,  ip: 6000,  td: 0.08 } },
      { name: 'Relay 3', en: false, s1: { en: false, ip: 1000,  tms: 0.8,  ct: 'VI', mop: 30 }, s2: { en: false, ip: 10,  tms: 0.85, ct: 'EI', mop: 30 }, dt: { en: true,  ip: 6000,  td: 0.08 } }
    ],
    customDevices: [
